...
- Params
  ...
  - `options` **string | object** The options of the key event. If it is a string, it will be converted to an object, and the `scope` property will be set to the string value. If it is an object, the `scope` property will be set to the value of the `scope` property;
